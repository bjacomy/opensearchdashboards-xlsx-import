            ...
            >
              <EuiFlexGroup gutterSize="s" alignItems="center">
                <EuiFlexItem grow={false}>
                  <EuiFieldText id="osdID" value={this.state.osdId.model} onChange={this.osdIdChange}/>
                </EuiFlexItem>

                <EuiFlexItem grow={false}>
                  <span style={{fontSize: "x-small", margin: "-10px auto 2px 12px"}}>example rendering</span>
                  <EuiFieldText id="previewOsdID" placeholder="Custom ID preview" value={this.state.osdId.preview} readOnly/>
                </EuiFlexItem>
              </EuiFlexGroup>
            </EuiFormRow>
